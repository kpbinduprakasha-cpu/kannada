...
1. **Household Waste Pickup Proximity Alert (< 500m)**:
   - Tracks BBMP garbage collection vehicles in real-time.
   - When a vehicle enters within 500 meters of a citizen's house, an instant alert banner pops up, playing the traditional chime and Kannada + English voice announcement (*"BBMP ಕಸದ ವಾಹನ ಬಂದಿದೆ! / BBMP Waste collection truck is near your home!"*).

2. **Roadside Spot Garbage Reporting & 5km Worker Dispatch**:
...
3. **Sanitation Worker Live Proof of Work**:
...
4. **10-Minute SLA Watchdog & Red Alert Badges**:
...
5. **AI Vision Verification (Before vs. After)**:
...
6. **₹4,000 Monthly Milestone Reward**:
...
7. **Strict Multi-Role Security & Aadhaar OTP**:
...
8. **SHA-256 Blockchain Audit Explorer**:
...
9. **Bengaluru GIS Municipal Radar Map**:
